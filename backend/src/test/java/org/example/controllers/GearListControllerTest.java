...
class GearListControllerTest {
    ...
    void getAll() throws Exception {
        GearList gearListOne = new GearList("Hennesy Hammock", "Shelter", "A mix of a tent and hammock", 1, new BigDecimal(".5"), new BigDecimal("0"), 1);
        GearList gearListTwo = new GearList("Sandals", "Footwear", "Great for comfort at the campsite!", 1, new BigDecimal("10"), new BigDecimal("0"), 1);
        GearList gearListThree = new GearList("Toothbrush", "Hygiene", "Optionally cut in half to save space and weight!", 0, new BigDecimal(".5"), new BigDecimal("1"), 1);
        GearList gearListFour = new GearList("Toothpaste", "Hygiene", "Freshen up!", 0, new BigDecimal(".2"), new BigDecimal("0"), 1);
        GearList gearListFive = new GearList("Hand Sanitizer", "Hygiene", "Nice to have, while backpacking.", 0, new BigDecimal(".2"), new BigDecimal("1.99"), 1);
        GearList gearListSix = new GearList("Nalgene 1 Quart Water Bottle", "Water", "Crucial for staying hydrated!", 2, new BigDecimal("4"), new BigDecimal("0"), 1);
        GearList gearListSeven = new GearList("Ultralight/Watertight .3 Medical Kit", "Emergencies", "Ideal for backpacking", 0, new BigDecimal("2.6"), new BigDecimal("10.95"), 2);
    ...
    void getGearBackpackId() throws Exception{
        ...
        List<GearList> mockGearList = List.of(
             new GearList("Hennesy Hammock", "Shelter", "A mix of a tent and hammock", 1, new BigDecimal(".5"), new BigDecimal("0"), 1),
             new GearList("Sandals", "Footwear", "Great for comfort at the campsite!", 1, new BigDecimal("10"), new BigDecimal("0"), 1)
        );
    ...
    void updateGearItem() throws Exception {
        GearList gearListItem = new GearList(1,"Nalgene 1 Quart Water Bottle", "Water", "Crucial for staying hydrated!", 2, new BigDecimal("4"), new BigDecimal("0"), 1);
