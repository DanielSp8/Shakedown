...
class GearListDaoTest {
    ...
    @Test
    @Order(1)
    @DisplayName("Gets all the gear fields in the 1st row")
    ...
    void batchInsertGearListItems() {
        ...
        List<GearList> newItems = List.of(
                new GearList(0, "Decatur Backpack", "Backpack", "A great backpack I currently own.", 1, new BigDecimal("3.4"), new BigDecimal("0"), 2),
    ...
    void addGearItemAndFetchItem() {
        GearList newGearItem = new GearList("Small Candle", "Emergencies", "A small candle to help start a fire in wet and difficult circumstances.", 0, new BigDecimal("2.50"), new BigDecimal("3.99"), 1);
