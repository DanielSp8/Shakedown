...
INSERT INTO gear_lists (item_name, category, description, weight_lbs, weight_oz, price, backpack_id)
	VALUES ('Hennesy Hammock', 'Shelter', 'This is a mix of a tend a hammock.  Lightweight and mixes it up!', 1, .5, 0, 2),
            ...
            ('Sandals', 'Footwear', 'Great for comfort at the campsite!', 1, 10, 0, 2),
            ('Toothbrush', 'Hygiene', 'Optionally cut in half to save space!', 0, .5, 1, 2),
            ('Toothpaste', 'Hygiene', 'Freshen up!', 0, .2, 0, 2),
            ('Hand Sanitizer', 'Hygiene', 'Nice to have, while backpacking.', 0, .2, 1.99, 2),
            ('Baby Wipes', 'Hygiene', 'Optional, but nice to have for cleanliness.', 0, .2, 1.99, 2),
            ('Smart Phone', 'Gadgets and Gear', 'Great for listening to music or potentially contacting people, especially in emergencies.', 0, 13, 0, 2),
            ('Portable Phone Charger', 'Gadgets and Gear', 'Great and useful item to have on the trail.', 0, 2, 0, 2),
            ('Rain Jacket', 'Clothing', 'Important, crucial item to have!', 0, 15, 0, 2),
            ('Nalgene 1 Quart Water Bottle', 'Water', 'Crucial for staying hydrated!', 2, 4, 0, 2),
            ('Nalgene 1 Quart Water Bottle', 'Water', 'Crucial for staying hydrated!', 2, 4, 0, 2),
			('Steripen UV Water Purifier', 'Water', 'When backpacking, the rechargeable Katadyn Steripen Ultra UV water purifier is a great source for potable water.',
                 0, 4.94, 129.95, 2),
			('Platypus Platy 2L Reservoir', 'Water', 'Great item to have for storing water!', 0, 7, 44.99, 2),
            ('Jetboil Stove', 'Cooking and Eating', 'Great stove!  Boils water quickly!', 1, 15, 0, 2),
            ('Headlamp', 'Gadgets and Gear', 'Incredibly useful!', 0, 2, 0, 2),
            ('Trowel', 'Hygiene', 'Important for digging a hole, to drop a deuce in the woods!', 0, 7, 0, 2),
            ('Toilet Paper', 'Hygiene', 'Use leaves instead?  No thankyou!', 0, 6, 0, 2),
            ('Small Journal', 'Miscellaneous', 'Great for journaling, taking notes and writing down my thoughts.', 0, 5, 0, 2),
            ('Wallet', 'Miscellaneous', 'Important to keep valuable with me.', 0, 1, 0, 2),
            ('Spyder Knife', 'Gadgets and Gear', 'Very useful!', 0, 3, 0, 2),
            ('Board Shorts', 'Clothing', 'Great for going for a dip in pond and relaxing!', 0, 2, 0, 2),
            ('Hiking Socks', 'Clothing', 'Valuable item to help prevent blisters', 0, 1, 0, 2),
            ('Trail Shoes', 'Footwear', 'Wonderful, lightweight item to bring along.  A great help to keep my feet comfortable.', 0, 15, 0, 2),
