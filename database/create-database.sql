...
INSERT INTO gear_lists (item_name, category, description, weight_lbs, weight_oz, price, private_value, owner_username, backpack_id)
	VALUES ('Fly Creek 2 Person 3 Season Tent', 'Shelter', 'The Fly Creek HV UL Solution Dye Two-Person Tent still maintains the ultralight weight that minimalist backpackers look for, but Big Agnes redesigned it with a higher volume to give a comfier sleeping space.', 
            ...
            0, .9, 23.95, false, 'admin', 1);

INSERT INTO gear_lists (item_name, category, description, weight_lbs, weight_oz, price, private_value, owner_username, backpack_id)
	VALUES ('Hennesy Hammock', 'Shelter', 'This is a mix of a tent and a hammock.  Lightweight and mixes it up!', 1, .5, 0, false, 'user', 2),
			('40 Degree Marmot Sleeping Bag', 'Sleeping', 'This is an old, but good sleeping bag I own', 2, 10, 0, false, 'user', 2),
            ('Therma-a-Rest Sleeping Pad', 'Sleeping', 'Great for a more comfortable night sleep!', 2, 7, 120, false, 'user', 2),
            ('Deuter Backpack', 'Backpack', 'A great backpack I own, comfortable and durable.', 1, 9, 0, false, 'user', 2),
            ('Sandals', 'Footwear', 'Great for comfort at the campsite!', 1, 10, 0, false, 'user', 2),
            ('Toothbrush', 'Hygiene', 'Optionally cut in half to save space!', 0, .5, 1, false, 'user', 2),
            ('Toothpaste', 'Hygiene', 'Freshen up!', 0, .2, 0, false, 'user', 2),
            ('Hand Sanitizer', 'Hygiene', 'Nice to have, while backpacking.', 0, .2, 1.99, false, 'user', 2),
            ('Baby Wipes', 'Hygiene', 'Optional, but nice to have for cleanliness.', 0, .2, 1.99, false, 'user', 2),
            ('Smart Phone', 'Gadgets and Gear', 'Great for listening to music or potentially contacting people, especially in emergencies.', 0, 13, 0, false, 'user', 2),
            ('Portable Phone Charger', 'Gadgets and Gear', 'Great and useful item to have on the trail.', 0, 2, 0, false, 'user', 2),
            ('Rain Jacket', 'Clothing', 'Important, crucial item to have!', 0, 15, 0, false, 'user', 2),
            ('Nalgene 1 Quart Water Bottle', 'Water', 'Crucial for staying hydrated!', 2, 4, 0, false, 'user', 2),
            ('Nalgene 1 Quart Water Bottle', 'Water', 'Crucial for staying hydrated!', 2, 4, 0, false, 'user', 2),
			('Steripen UV Water Purifier', 'Water', 'When backpacking, the rechargeable Katadyn Steripen Ultra UV water purifier is a great source for potable water.',
                 0, 4.94, 129.95, false, 'user', 2),
			('Platypus Platy 2L Reservoir', 'Water', 'Great item to have for storing water!', 0, 7, 44.99, false, 'user', 2),
            ('Jetboil Stove', 'Cooking and Eating', 'Great stove!  Boils water quickly!', 1, 15, 0, false, 'user', 2),
            ('Headlamp', 'Gadgets and Gear', 'Incredibly useful!', 0, 2, 0, false, 'user', 2),
            ('Trowel', 'Hygiene', 'Important for digging a hole, to drop a deuce in the woods!', 0, 7, 0, false, 'user', 2),
            ('Toilet Paper', 'Hygiene', 'Use leaves instead?  No thankyou!', 0, 6, 0, false, 'user', 2),
            ('Small Journal', 'Miscellaneous', 'Great for journaling, taking notes and writing down my thoughts.', 0, 5, 0, false, 'user', 2),
            ('Wallet', 'Miscellaneous', 'Important to keep valuable with me.', 0, 1, 0, false, 'user', 2),
            ('Spyder Knife', 'Gadgets and Gear', 'Very useful!', 0, 3, 0, false, 'user', 2),
            ('Board Shorts', 'Clothing', 'Great for going for a dip in pond and relaxing!', 0, 2, 0, false, 'user', 2),
            ('Hiking Socks', 'Clothing', 'Valuable item to help prevent blisters', 0, 1, 0, false, 'user', 2),
            ('Trail Shoes', 'Footwear', 'Wonderful, lightweight item to bring along.  A great help to keep my feet comfortable.', 0, 15, 0, false, 'user', 2),
            ('Underwear', 'Clothing', 'Tight-fitting to help prevent chaffing.  Comfort is a must!', 0, 2, 0, false, 'user', 2),
            ('Spork', 'Cooking and Eating', 'Remember this helpful utensil...', 0, .7, 0, false, 'user', 2),
            ('Stuff Sack', 'Miscellaneous', 'Useful for hanging smellables in a bear bag', 0, 4.5, 0, false, 'user', 2), 
            ('Ultralight/Watertight .3 Medical Kit', 'Emergencies', 'Ideal for backpacking', 0, 2.6, 10.95, false, 'user', 2);
            
INSERT INTO gear_lists (item_name, category, description, weight_lbs, weight_oz, price, private_value, owner_username, backpack_id)
	VALUES ('Eureka 2 Person Tent', 'Shelter', 'This is a decent tent.  Lightweight and durable!', 3, 5, 0, true, 'user', 3),
			('35 Degree Marmot Sleeping Bag', 'Sleeping', 'This is good sleeping bag!', 2, 10, 0, true, 'user', 3),
            ('Therma-a-Rest Sleeping Pad', 'Sleeping', 'Great for a more comfortable night sleep!', 2, 7, 120, true, 'user', 3),
            ('Arc Teryx', 'Backpack', 'A wonderful backpack!  Comfortable and durable.', 1, 11, 0, true, 'user', 3),
            ('Sandals', 'Footwear', 'Great for comfort at the campsite!', 1, 10, 0, true, 'user', 3),
            ('Toothbrush', 'Hygiene', 'Cut in half to save space and weight!', 0, .5, 1, true, 'user', 3),
            ('Toothpaste', 'Hygiene', 'Freshen up!', 0, .2, 0, true, 'user', 3),
            ('Hand Sanitizer', 'Hygiene', 'Nice to have', 0, .2, 1.99, true, 'user', 3),
            ('Baby Wipes', 'Hygiene', 'Optional, but nice to have for cleanliness.', 0, .2, 1.99, true, 'user', 3),
            ('Rain Jacket', 'Clothing', 'Crucial item to have!', 0, 15, 0, true, 'user', 3),
            ('Nalgene 1 Quart Water Bottle', 'Water', 'Crucial for staying hydrated!', 2, 4, 0, true, 'user', 3),
            ('Nalgene 1 Quart Water Bottle', 'Water', 'Crucial for staying hydrated!', 2, 4, 0, true, 'user', 3),
			('Steripen UV Water Purifier', 'Water', 'When backpacking, the rechargeable Katadyn Steripen Ultra UV water purifier is a great source for potable water.',
                 0, 4.94, 129.95, true, 'user', 3),
			('Platypus Platy 2L Reservoir', 'Water', 'Great item to have for storing water!', 0, 7, 44.99, true, 'user', 3),
            ('Jetboil Stove', 'Cooking and Eating', 'Great stove!  Boils water quickly!', 1, 15, 0, true, 'user', 3),
            ('Headlamp', 'Gadgets and Gear', 'Incredibly useful!', 0, 2, 0, true, 'user', 3),
            ('Trowel', 'Hygiene', 'Important for digging a hole, to drop a deuce in the woods!', 0, 7, 0, true, 'user', 3),
            ('Toilet Paper', 'Hygiene', 'Use leaves instead?  No thankyou!', 0, 6, 0, true, 'user', 3),
            ('Small Journal', 'Miscellaneous', 'Great for journaling, taking notes and writing down my thoughts.', 0, 5, 0, true, 'user', 3),
            ('Wallet', 'Miscellaneous', 'Important to keep valuable with me.', 0, 1, 0, true, 'user', 3),
            ('Spyder Knife', 'Gadgets and Gear', 'Very useful!', 0, 3, 0, true, 'user', 3),
            ('Board Shorts', 'Clothing', 'Comfortable and great for going for a dip in the water and relaxing!', 0, 2, 0, true, 'user', 3),
            ('Hiking Socks', 'Clothing', 'Valuable item to help prevent blisters', 0, 1, 0, true, 'user', 3),
            ('Trail Shoes', 'Footwear', 'Wonderful, lightweight item to bring along.  A great help to keep my feet comfortable.', 0, 15, 0, true, 'user', 3),
            ('Underwear', 'Clothing', 'Tight-fitting to help prevent chaffing.  Comfort is a must!', 0, 2, 0, true, 'user', 3),
            ('Spork', 'Cooking and Eating', 'Remember this helpful utensil...', 0, .7, 0, true, 'user', 3),
            ('Stuff Sack', 'Miscellaneous', 'Useful for hanging smellables in a bear bag', 0, 4.5, 0, true, 'user', 3), 
            ('Ultralight/Watertight .3 Medical Kit', 'Emergencies', 'Ideal for backpacking', 0, 2.6, 10.95, true, 'user', 3);
